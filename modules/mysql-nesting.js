	...
	for(var r=0; r<rows.length; r++) {
		if(rows[r][''] && rows[r][''].remainHours) {
			rows[r].remaindayshours = {
				...
				likesCount: rows[r][''].likesCount, 
				alreadyLiked: rows[r][''].alreadyLiked, 
				viewsCount: rows[r][''].viewsCount, 
				commentsCount: rows[r][''].commentsCount, 
				supportersCount: rows[r][''].supportersCount, 
